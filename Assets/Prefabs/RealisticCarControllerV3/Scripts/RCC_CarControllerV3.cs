...
public class RCC_CarControllerV3 : RCC_Core {
	...
	[Range(0f, 1f)]public float baseMinEngineSoundVolume = .05f;
	[Range(0f, 1f)]public float baseMaxEngineSoundVolume = .85f;
	[Range(0f, 1f)]public float baseIdleEngineSoundVolume = .85f;
